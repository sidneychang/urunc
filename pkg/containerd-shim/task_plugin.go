	...
	plugin.Register(&plugin.Registration{
		...
		InitFn: func(ic *plugin.InitContext) (interface{}, error) {
			...
			return &taskService{
				...
				// containerd's v2 shim is started with cwd set to the container bundle:
				//   <stateRoot>/<namespace>/<containerID>
				// Two Dir segments yield stateRoot. This matches containerd's layout
				// today; if that changes, bundlePathFor on Delete must be updated.
